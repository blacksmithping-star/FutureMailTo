...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-surface">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          {/* Social Buttons (Top on mobile) */}
          ...
          <div className="md:order-1 text-center md:text-left">
            <span className="text-white text-xl">
              Made With 💜 by
              <span
                className="bg-gradient-to-r text-xl from-cyan-400 to-purple-500 bg-clip-text text-transparent ml-2 transition-all duration-300 hover:from-purple-500 hover:to-cyan-400"
              >
                Shahariar Rijon
              </span>
            </span>
